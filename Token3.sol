...
contract Escrow {
    ...
    event MessageSent(address buyer, string message);
    ...
    function sendNotification(address _recipient, string memory _message) private {
    ...
    function confirmDelivery() public payable onlyBuyer {
        ...
        sendNotification(buyer, "Escrow Payment Successful");
    ...
    function sendMessage() public payable {
        ...
        sendNotification(msg.sender, "Hi");

        emit MessageSent(msg.sender, "Hi");
    }
}
